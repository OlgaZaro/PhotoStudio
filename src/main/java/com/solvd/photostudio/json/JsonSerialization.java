...
public class JsonSerialization {
    ...
    public static void serializationCustomer() throws IOException {
        ...
        mapper.writeValue(new File(new PropertiesUtil("jsonCustom").getPath()), customer);
    }
    ...
    public static void serializationGiftCertificate() throws IOException {
        ...
        mapper1.writeValue(new File(new PropertiesUtil("jsonGiftCertificate").getPath()), giftCertificate);
    }
    ...
    public static void serializationOrderRental() throws IOException {
        ...
        mapper2.writeValue(new File(new PropertiesUtil("jsonOrderRental").getPath()), orderRental);
    }
    ...
    public static void serializationServiceOrder() throws IOException {
        ...
        mapper3.writeValue(new File(new PropertiesUtil("jsonServiceOrder").getPath()), serviceOrder);
    }
    ...
    public static void serializationSubscription() throws IOException {
        ...
        mapper4.writeValue(new File(new PropertiesUtil("jsonSubscription").getPath()), subscription);
    }
}
